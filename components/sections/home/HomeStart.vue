<template>
    <section id="start" class="min-h-screen flex items-center">
      <LayoutMoContainer>
        <LayoutMoGrid class="ml-8 mr-8 md:ml-[25%] md:mr-[25%]" grid-columns="1">
          <div class="text-center">
            <img class="w-[80px] mx-auto mb-12" src="~/assets/img/logo/moglicodes_logo.svg" alt="MogliCodes Logo" />
