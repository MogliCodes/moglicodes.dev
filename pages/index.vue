...
const {
  ...
  error,
  pending
} = await useFetch(`https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=Moglash&api_key=748db0d5fc56991d10aad4ce5165e345&limit=1&format=json`, {server: false})
